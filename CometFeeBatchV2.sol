...
// File @openzeppelin/contracts-upgradeable/token/ERC20/extensions/IERC20MetadataUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC20/ERC20Upgradeable.sol@v4.3.3
...
// File contracts/BIFI/infra/CometFeeBatchV2.sol
...
contract CometFeeBatchV2 is Initializable, OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public wNative;
    IERC20Upgradeable public comet;
    ...
    address[] public wNativeToCometRoute;
    ...
    event NewCometRoute(address[] oldRoute, address[] newRoute);
    ...
    function initialize(
        ...
        comet = IERC20Upgradeable(_comet);
        ...
        wNativeToCometRoute = [_wNative, _comet];
    }

    // Main function. Divides Comet's profits.
    function harvest() public {
        ...
        if (routerInitialized) {
            ...
            IUniswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wNativeToCometRoute, treasury, block.timestamp);
        } else {
    ...
    function setNativeToCometRoute(address[] memory _route) external onlyOwner {
        require(_route[0] == address(wNative), "!wNative");
        require(_route[_route.length - 1] == address(comet), "!comet");

        emit NewCometRoute(wNativeToCometRoute, _route);
        wNativeToCometRoute = _route;
    }
