...
contract StratManager is Ownable, Pausable {
     ...
     * @param _communityFeeRecipient address where to send Beefy's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
     ...
     * @param _communityFeeRecipient new beefy fee recipient address.
     */
    function setcommunityFeeRecipient(address _communityFeeRecipient) external onlyOwner {
        communityFeeRecipient = _communityFeeRecipient;
    }
...
contract StrategyCommonChefLP is StratManager, FeeManager {
    ...
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _communityFeeRecipient) public {
        want = _want;
        poolId = _poolId;
        chef = _chef;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        IERC20(native).safeTransfer(communityFeeRecipient, beefyFeeAmount);
...
contract GasThrottler {
    ...
    address public gasprice = address(0x608f73460bFf6dD3a9EB083096d912Ad66778Bf9);
...
contract StrategyCommonChefLPFtm is StrategyCommonChefLP, GasThrottler {
